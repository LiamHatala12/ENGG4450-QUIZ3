public class Distance {
    ...
    public static final double euclideanDistance(double x1, double y1, double x2, double y2) {
        double x = Math.pow((x1 - x2), 2); // Square of the x difference
        double y = Math.pow((y1 - y2), 2); // Square of the y difference
        double sqrt = Math.sqrt(x + y);    // Square root of the sum of squares
        return sqrt;
    }
}
